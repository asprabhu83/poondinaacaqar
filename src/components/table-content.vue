<template>
  ...
  <div v-if="$route.params.tableid == 'list-course-outcomes'">
      <div class="list">
          <div class="item">
              <div class="heading cnt"  >1.1.1. List of courses supporting Local, National, Regional and Global outcomes<button type="button" class="back_btn" @click="this.$router.go(-1)"><i class="fas fa-chevron-left" ></i> Back</button></div> 
             <div class="sub_items">
                 <div class="table_contents courses" style="overflow-x:auto;" >
                    <table>
                        <thead>
                        ...
                        <tbody>
                            <tr v-for="item in tables.t_1_1_1" :key="item.id">
                                <td style="width:20%;" >{{item.name}}</td>
                                <td class="pdf_items" ><a :href="$store.state.siteUrl + item.ug" v-if="item.ug !== ''"  target="_blank" ><img src="../assets/pdf_icon2.png" style="width:20px;" /></a> <span v-else> - </span> </td>
                                <td class="pdf_items"> <a :href="$store.state.siteUrl + item.pg" v-if="item.pg !== ''"  target="_blank" ><img src="../assets/pdf_icon2.png" style="width:20px;" /></a> <span v-else> - </span> </td>
  ...
  <div v-if="$route.params.tableid == 'mentor-register'">
      <div class="list">
          <div class="item">
  ...
  <div v-if="$route.params.tableid == 'seed-money'">
      <div class="list">
          <div class="item">
  ...
  <div v-if="$route.params.tableid == 'course-outcomes'">
      <div class="list">
          <div class="item">
  ...
  <div v-if="$route.params.tableid == 'experiential_learning'">
      <div class="list">
          <div class="item">
  ...
  <div v-if="$route.params.tableid == 'participative_learning'">
      <div class="list">
          <div class="item">
  ...
  <div v-if="$route.params.tableid == 'advanced_learners'">
      <div class="list">
          <div class="item">
  ...
  <div v-if="$route.params.tableid == 'slow_learners'">
      <div class="list">
          <div class="item">
  ...
  <div v-if="$route.params.tableid == 'e_content_lectures'">
      <div class="list">
          <div class="item">
  ...
  <div v-if="$route.params.tableid == 'video_lectures'">
      <div class="list">
          <div class="item">
  ...
  <div v-if="$route.params.tableid == 'gender_action_plan'">
      <div class="list">
          <div class="item">
  ...
  <div v-if="$route.params.tableid == 'provided_for_women'">
      <div class="list">
          <div class="item">
  ...
  <div v-if="$route.params.tableid == '1.3.3_2015_2016'">
      <div class="list">
          <div class="item">
  ...
  <div v-if="$route.params.tableid == '1.3.3_2016_2017'">
      <div class="list">
          <div class="item">
              <div class="heading cnt"  >Value Added Courses attendance and results<button type="button" class="back_btn" @click="this.$router.go(-1)"><i class="fas fa-chevron-left" ></i> Back</button></div> 
             <div class="sub_items">
  ...
  <div v-if="$route.params.tableid == '1.3.3_2017_2018'">
      <div class="list">
          <div class="item">
              <div class="heading cnt"  >Value Added Courses attendance and results<button type="button" class="back_btn" @click="this.$router.go(-1)"><i class="fas fa-chevron-left" ></i> Back</button></div> 
             <div class="sub_items">
  ...
  <div v-if="$route.params.tableid == '1.3.3_2018_2019'">
      <div class="list">
          <div class="item">
              <div class="heading cnt"  >Value Added Courses attendance and results<button type="button" class="back_btn" @click="this.$router.go(-1)"><i class="fas fa-chevron-left" ></i> Back</button></div> 
             <div class="sub_items">
  ...
  <div v-if="$route.params.tableid == '1.3.3_2019_2020'">
      <div class="list">
          <div class="item">
              <div class="heading cnt"  >Value Added Courses attendance and results<button type="button" class="back_btn" @click="this.$router.go(-1)"><i class="fas fa-chevron-left" ></i> Back</button></div> 
             <div class="sub_items">
  ...
  <div v-if="$route.params.tableid == '1.1.3_2015_2016'">
      <div class="list">
          <div class="item">
  ...
  <div v-if="$route.params.tableid == '1.1.3_2016_2017'">
      <div class="list">
          <div class="item">
              <div class="heading cnt"  >Courses focus on employability<button type="button" class="back_btn" @click="this.$router.go(-1)"><i class="fas fa-chevron-left" ></i> Back</button></div> 
             <div class="sub_items">
  ...
  <div v-if="$route.params.tableid == '1.1.3_2017_2018'">
      <div class="list">
          <div class="item">
              <div class="heading cnt"  >Courses focus on employability<button type="button" class="back_btn" @click="this.$router.go(-1)"><i class="fas fa-chevron-left" ></i> Back</button></div> 
             <div class="sub_items">
  ...
  <div v-if="$route.params.tableid == '1.1.3_2018_2019'">
      <div class="list">
          <div class="item">
              <div class="heading cnt"  >Courses focus on employability<button type="button" class="back_btn" @click="this.$router.go(-1)"><i class="fas fa-chevron-left" ></i> Back</button></div> 
             <div class="sub_items">
  ...
  <div v-if="$route.params.tableid == '1.1.3_2019_2020'">
      <div class="list">
          <div class="item">
              <div class="heading cnt"  >Courses focus on employability<button type="button" class="back_btn" @click="this.$router.go(-1)"><i class="fas fa-chevron-left" ></i> Back</button></div> 
             <div class="sub_items">
  ...
  <div v-if="$route.params.tableid == '3.1.2_2015_2016'">
      <div class="list">
          <div class="item">
              <div class="heading cnt"  >Policy documents for Sanction of seed money<button type="button" class="back_btn" @click="this.$router.go(-1)"><i class="fas fa-chevron-left" ></i> Back</button></div> 
             <div class="sub_items">
  ...
  <div v-if="$route.params.tableid == '3.1.2_2016_2017'">
      <div class="list">
          <div class="item">
              <div class="heading cnt"  >Policy documents for Sanction of seed money<button type="button" class="back_btn" @click="this.$router.go(-1)"><i class="fas fa-chevron-left" ></i> Back</button></div> 
             <div class="sub_items">
  ...
  <div v-if="$route.params.tableid == '3.1.2_2017_2018'">
      <div class="list">
          <div class="item">
              <div class="heading cnt"  >Policy documents for Sanction of seed money<button type="button" class="back_btn" @click="this.$router.go(-1)"><i class="fas fa-chevron-left" ></i> Back</button></div> 
             <div class="sub_items">
  ...
  <div v-if="$route.params.tableid == '3.1.2_2018_2019'">
      <div class="list">
          <div class="item">
              <div class="heading cnt"  >Policy documents for Sanction of seed money<button type="button" class="back_btn" @click="this.$router.go(-1)"><i class="fas fa-chevron-left" ></i> Back</button></div> 
             <div class="sub_items">
  ...
  <div v-if="$route.params.tableid == '3.1.2_2019_2020'">
      <div class="list">
          <div class="item">
              <div class="heading cnt"  >Policy documents for Sanction of seed money<button type="button" class="back_btn" @click="this.$router.go(-1)"><i class="fas fa-chevron-left" ></i> Back</button></div> 
             <div class="sub_items">
  ...
  <div v-if="$route.params.tableid == '3.7.2_2015_2016'">
      <div class="list">
          <div class="item">
  ...
  <div v-if="$route.params.tableid == '3.7.2_2016_2017'">
      <div class="list">
          <div class="item">
              <div class="heading cnt"  >Functional MoUs <button type="button" class="back_btn" @click="this.$router.go(-1)"><i class="fas fa-chevron-left" ></i> Back</button></div> 
             <div class="sub_items">
  ...
  <div v-if="$route.params.tableid == '3.7.2_2017_2018'">
      <div class="list">
          <div class="item">
              <div class="heading cnt"  >Functional MoUs <button type="button" class="back_btn" @click="this.$router.go(-1)"><i class="fas fa-chevron-left" ></i> Back</button></div> 
             <div class="sub_items">
  ...
  <div v-if="$route.params.tableid == '3.7.2_2018_2019'">
      <div class="list">
          <div class="item">
              <div class="heading cnt"  >Functional MoUs <button type="button" class="back_btn" @click="this.$router.go(-1)"><i class="fas fa-chevron-left" ></i> Back</button></div> 
             <div class="sub_items">
  ...
  <div v-if="$route.params.tableid == '3.7.2_2019_2020'">
      <div class="list">
          <div class="item">
              <div class="heading cnt"  >Functional MoUs <button type="button" class="back_btn" @click="this.$router.go(-1)"><i class="fas fa-chevron-left" ></i> Back</button></div> 
             <div class="sub_items">
  ...
  <div v-if="$route.params.tableid == '3.7.1_2015_2016'">
      <div class="list">
          <div class="item">
  ...
  <div v-if="$route.params.tableid == '3.7.1_2016_2017'">
      <div class="list">
          <div class="item">
              <div class="heading cnt"  >Collaborative activities <button type="button" class="back_btn" @click="this.$router.go(-1)"><i class="fas fa-chevron-left" ></i> Back</button></div> 
             <div class="sub_items">
  ...
  <div v-if="$route.params.tableid == '3.7.1_2017_2018'">
      <div class="list">
          <div class="item">
              <div class="heading cnt"  >Collaborative activities <button type="button" class="back_btn" @click="this.$router.go(-1)"><i class="fas fa-chevron-left" ></i> Back</button></div> 
             <div class="sub_items">
  ...
  <div v-if="$route.params.tableid == '3.7.1_2018_2019'">
      <div class="list">
          <div class="item">
              <div class="heading cnt"  >Collaborative activities <button type="button" class="back_btn" @click="this.$router.go(-1)"><i class="fas fa-chevron-left" ></i> Back</button></div> 
             <div class="sub_items">
  ...
  <div v-if="$route.params.tableid == '3.7.1_2019_2020'">
      <div class="list">
          <div class="item">
              <div class="heading cnt"  >Collaborative activities <button type="button" class="back_btn" @click="this.$router.go(-1)"><i class="fas fa-chevron-left" ></i> Back</button></div> 
             <div class="sub_items">
  ...
  <div v-if="$route.params.tableid == '5.1.1_2015_2016'">
      <div class="list">
          <div class="item">
  ...
  <div v-if="$route.params.tableid == '5.1.1_2016_2017'">
      <div class="list">
          <div class="item">
              <div class="heading cnt"  >Scholarship and freeship-govt. <button type="button" class="back_btn" @click="this.$router.go(-1)"><i class="fas fa-chevron-left" ></i> Back</button></div> 
             <div class="sub_items">
  ...
  <div v-if="$route.params.tableid == '5.1.1_2017_2018'">
      <div class="list">
          <div class="item">
              <div class="heading cnt"  >Scholarship and freeship-govt. <button type="button" class="back_btn" @click="this.$router.go(-1)"><i class="fas fa-chevron-left" ></i> Back</button></div> 
             <div class="sub_items">
  ...
  <div v-if="$route.params.tableid == '5.1.1_2018_2019'">
      <div class="list">
          <div class="item">
              <div class="heading cnt"  >Scholarship and freeship-govt. <button type="button" class="back_btn" @click="this.$router.go(-1)"><i class="fas fa-chevron-left" ></i> Back</button></div> 
             <div class="sub_items">
  ...
  <div v-if="$route.params.tableid == '5.1.1_2019_2020'">
      <div class="list">
          <div class="item">
              <div class="heading cnt"  >Scholarship and freeship-govt. <button type="button" class="back_btn" @click="this.$router.go(-1)"><i class="fas fa-chevron-left" ></i> Back</button></div> 
             <div class="sub_items">
  ...
  <div v-if="$route.params.tableid == '3.3.2_2015_2016'">
      <div class="list">
          <div class="item">
  ...
  <div v-if="$route.params.tableid == '3.3.2_2016_2017'">
      <div class="list">
          <div class="item">
              <div class="heading cnt"  >Workshop/seminars on RM,IPR and etc. <button type="button" class="back_btn" @click="this.$router.go(-1)"><i class="fas fa-chevron-left" ></i> Back</button></div> 
             <div class="sub_items">
  ...
  <div v-if="$route.params.tableid == '3.3.2_2017_2018'">
      <div class="list">
          <div class="item">
              <div class="heading cnt"  >Workshop/seminars on RM,IPR and etc. <button type="button" class="back_btn" @click="this.$router.go(-1)"><i class="fas fa-chevron-left" ></i> Back</button></div> 
             <div class="sub_items">
  ...
  <div v-if="$route.params.tableid == '3.3.2_2018_2019'">
      <div class="list">
          <div class="item">
              <div class="heading cnt"  >Workshop/seminars on RM,IPR and etc. <button type="button" class="back_btn" @click="this.$router.go(-1)"><i class="fas fa-chevron-left" ></i> Back</button></div> 
             <div class="sub_items">
  ...
  <div v-if="$route.params.tableid == '3.3.2_2019_2020'">
      <div class="list">
          <div class="item">
              <div class="heading cnt"  >Workshop/seminars on RM,IPR and etc. <button type="button" class="back_btn" @click="this.$router.go(-1)"><i class="fas fa-chevron-left" ></i> Back</button></div> 
             <div class="sub_items">
  ...
  <div v-if="$route.params.tableid == 'feedback-analysis'">
      <div class="list">
          <div class="item">
